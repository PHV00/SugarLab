...
public class EventoController {
    ...
    @PutMapping("eventos/edit/{id}")
    public ResponseEntity<Evento> editEvento(@PathVariable int id, @RequestBody EventoDTO dto){
        try {
            Evento newEvento = eventoService.editarEvento(id, dto);
