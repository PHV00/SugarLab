...
public class AlimentoTest {
    ...
    void shouldReturnExceptionNullableData(){
        AlimentoCadastroDto dto = new AlimentoCadastroDto(null, null);
    ...
    void shouldCreateAlimento(){
        AlimentoCadastroDto alimentoDto = new AlimentoCadastroDto("Bolo de cenoura", "Bolo feito com cenoura");
        Alimento alimento = new Alimento(1, "Bolo de cenoura", "Bolo feito com cenoura");
